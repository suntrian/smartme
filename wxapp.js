/**
 * Created by suntrian on 16-10-17.
 */
!function () {
    var e, t = function () {
    }
    ...
    !function () {
        ...
        location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
            ...
            angular.module("Controllers").controller("appController", ["$rootScope", "$scope", "$timeout", "$log", "$state", "$window", "ngDialog", "mmpop", "appFactory", "loginFactory", "contactFactory", "accountFactory", "chatFactory", "confFactory", "contextMenuFactory", "notificationFactory", "utilFactory", "reportService", "actionTrack", "surviveCheckService", "subscribeMsgService", "stateManageService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y, C, v, S) {
                function w() {
                ...
                t.$on("ngDialog.opened", function (e, t) {
                    S.change("dialog:open", !0),
                        F = t,
                        b()
                }),
                    t.$on("ngDialog.closed", function () {
                        S.change("dialog:open", !1),
                            F = null
                    }),
                ...
                D.on("dragenter", function (e) {
                    ...
                    D.on("dragleave", function (e) {
                        var t = e.originalEvent;
                        t.dataTransfer.dropEffect = "none",
                        k === t.target && D.removeClass("drop-enter"),
                            t.stopPropagation(),
                            t.preventDefault()
                    }),
            ...
            e.$watchCollection("chatContent", function (e) {
                if (e.length > 0 && e[e.length - 1].FromUserName === c.getUserName())
                    ...
                    if (N && clearTimeout(N),
                            ...
                            !P)
                        return;
                    E = w.scrollTop + w.clientHeight + 10 >= w.scrollHeight,
                        P = !1
                }
            }),
        ...
        angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
            ...
            var B, H = 20, j = 25, q = {
                ...
                onQueued: function () {
                    ...
                    this._uploadPreviewUpdate = w(e).update
                },
                onSuccess: function (e) {
    ...
    !function () {
        ...
        angular.module("Services").factory("accountFactory", ["$q", "confFactory", "utilFactory", function (e, t, o) {
            var n, r, a, i = {}, c = null, s = null, l = {
                type: "",
                ver: ""
            }, u = "" === o.getCookie("MM_WX_NOTIFY_STATE") ? t.MM_NOTIFY_OPEN : o.getCookie("MM_WX_NOTIFY_STATE"), f = "" === o.getCookie("MM_WX_SOUND_STATE") ? t.MM_SOUND_OPEN : o.getCookie("MM_WX_SOUND_STATE"), d = {
                openNotify: function () {
                    u = t.MM_NOTIFY_OPEN,
                ...
                getFormateSyncCheckKey: function () {
                    for (var e = s || this.getSyncKey(), t = e.List, o = [], n = 0, r = t.length; r > n; n++)
                        o.push(t[n].Key + "_" + t[n].Val);
                    return o.join("|")
                },
                setSyncCheckKey: function (e) {
                    e && e.Count > 0 ? s = e : o.log("JS Function: setSyncCheckKey. Error. no synccheckkey")
                },
            ...
            return u == t.MM_NOTIFY_OPEN ? d.openNotify() : d.closeNotify(),
                f == t.MM_SOUND_OPEN ? d.openSound() : d.closeSound(),
                d
        }
        ])
    }(),
    ...
    !function () {
        ...
        angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l, u) {
            ...
            var d, g = window._contacts = {}, m = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], S = [], w = [], b = {}, T = {}, E = 0, N = ["fmessage"], P = {
                isSelf: function () {
                ...
                addBatchgetContact: function (e, t, r) {
                    function i(e) {
                        f.resolve(e.ContactList),
                            ...
                            S = [],
                        !S.length && v.length > 0 && d.batchGetContact().then(i, s)
                    }
                    ...
                    function s(e) {
                        ...
                        S.length || !v.length && !w.length || d.batchGetContact().then(i, s)
                    }
                ...
                batchGetContact: function (e) {
                    var n = o.defer()
                        , i = 1;
                    return w.length ? (i = w.length < 6 || E > 2 ? 1 : w.length < 40 ? 5 : 10,
                        S = w.splice(0, i),
                        console.log("_contactsWithErrorToGetList lenght:", w.length)) : S = v.splice(0, 50),
                        t({
                            method: "POST",
    ...
    !function () {
        ...
        angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, o, n) {
            ...
            var y, C = 3e3, _ = [], v = [], S = {}, w = "reportService", b = g(), T = {
                jsError: "[js-error]",
            ...
            var p = a.find("body")
                ...
                open: function (l) {
                    ...
                    if (y.template ? template = y.template : y.templateUrl && (template = i.get(y.templateUrl)),
                            d.$result = S = e('<div id="' + C + '" class="mmpop" tabindex="-1"></div>'),
                            S.html(template),
                    ...
                    return w = y.container ? y.container : p,
                        c(S)(v),
                        m.enter(S, w),
                    y.autoFoucs && S.focus(),
                    ...
                    y.className && S.addClass(y.className),
                    y.top && S.css("top", y.top),
                    y.left && S.css("left", y.left),
                        v.closeThisMmPop = function (e) {
                            setTimeout(function () {
                                e && e.target && (e.target.id == C || S[0] && jQuery.contains(S[0], e.target)) || (h.closePop(S, e),
                                    v.$digest())
                            }, 0)
                        }
                        ,
                        ...
                        s && clearTimeout(s),
                            s = setTimeout(function () {
                                ...
                                if (-1 != l && -1 != u) {
                                    ...
                                    w && (document.createRange ? (v = document.createRange(),
                                        v.setStartAfter(w),
                                        v.collapse(!1),
                                        S = window.getSelection(),
                                        S.removeAllRanges(),
                                        S.addRange(v)) : document.selection && (v = document.body.createTextRange(),
        ...
        return {
            ...
            link: function (n, r) {
                ...
                n.isLoaded = !1,
                    ...
                    e.keyup(a);
                var M, y, C, v, S = 5, w = .1, b = .8 * p, T = .8 * h, E = {}, N = void 0 !== document.mozHidden, P = N ? "DOMMouseScroll" : "mousewheel";
            ...
            this.$get = ["$document", "$templateCache", "$compile", "$q", "$http", "$rootScope", "$timeout", "$window", "$controller", function (u, f, d, g, m, p, h, M, y) {
                ...
                var _ = {
                    ...
                    open: function (a) {
                        ...
                        return g.when(c(S.template || S.templateUrl)).then(function (t) {
                            if (f.put(S.template || S.templateUrl, t),
                                S.showClose && (t += '<div class="ngdialog-close"></div>'),
                                    u.$result = b = o('<div id="ngdialog' + r + '" class="ngdialog"></div>'),
                                    b.html(S.overlay ? '<div class="ngdialog-overlay"></div><div class="ngdialog-content">' + t + "</div>" : '<div class="ngdialog-content">' + t + "</div>"),
                                S.data && e.isString(S.data)) {
                                var a = S.data.replace(/^\s*/, "")[0];
                                E.ngDialogData = "{" === a || "[" === a ? e.fromJson(S.data) : S.data
                            } else
                                S.data && e.isObject(S.data) && (E.ngDialogData = S.data);
                            ...
                            if (S.className && b.addClass(S.className),
                                    T = S.appendTo && e.isString(S.appendTo) ? e.element(document.querySelector(S.appendTo)) : C,
                                    S.preCloseCallback) {
                                var c;
                                e.isFunction(S.preCloseCallback) ? c = S.preCloseCallback : e.isString(S.preCloseCallback) && E && (e.isFunction(E[S.preCloseCallback]) ? c = E[S.preCloseCallback] : E.$parent && e.isFunction(E.$parent[S.preCloseCallback]) ? c = E.$parent[S.preCloseCallback] : p && e.isFunction(p[S.preCloseCallback]) && (c = p[S.preCloseCallback])),
                            ...
                            if (E.closeThisDialog = function (e) {
                                    ...
                                    h(function () {
                                        ...
                                        t > 0 && _.setBodyPadding(t),
                                            T.append(b),
                                            S.name ? p.$broadcast("ngDialog.opened", {
                                                dialog: b,
                                                name: S.name
                                            }) : p.$broadcast("ngDialog.opened", b)
                                    }),
                                S.closeByEscape && C.bind("keydown", _.onDocumentKeydown),
                                S.closeByNavigation && p.$on("$locationChangeSuccess", function () {
                                    _.closeDialog(b)
                                }),
                                    n = function (e) {
                                        var t = S.closeByDocument ? o(e.target).hasClass("ngdialog-overlay") : !1
